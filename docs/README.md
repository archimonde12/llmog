...
### New Developer
1. [`services/service-map.md`](./services/service-map.md)
2. [`conventions/doc-maintenance.md`](./conventions/doc-maintenance.md)
3. [`decisions/README.md`](./decisions/README.md)

### On-call
1. [`runbooks/incident/README.md`](./runbooks/incident/README.md)
...
- `services/`: high-level service map.
